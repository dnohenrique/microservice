...
{
    public abstract class EmpresaCommandValidation<T> : AbstractValidator<T> where T : EmpresaCommand<string>
    {
        ...
        private bool ShouldHaveAtLeastOneResponsavel(List<Responsavel> responsavel)
        {
            return responsavel != null && responsavel.Any();
        }
